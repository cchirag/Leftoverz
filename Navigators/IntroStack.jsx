...
export default function IntroStack(){
    return(
        <Stack.Navigator screenOptions = {{cardStyleInterpolator: CardStyleInterpolators.forHorizontalIOS}}>
            ...
            <Stack.Screen name = "Sign In" component = {SignInPage} options = {{header: props => null, gestureEnabled: true}}></Stack.Screen>
            <Stack.Screen name = "Sign Up" component = {SignUpPage} options = {{header: props => null, gestureEnabled: true}}></Stack.Screen>
        </Stack.Navigator>
    )
}